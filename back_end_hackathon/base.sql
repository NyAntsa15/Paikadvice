create database hackaton;
	...
	insert into TypeTache (TypeTache) values('Decouvertes');

	insert into Agri (Nom,Prenom,date_de_naissance,Region,email,mot_de_passe,ClePrive)values('RA','MOMO','2002-01-12','Analamanga','momo@gmail.com','momo','2');
	insert into Agri (Nom,Prenom,date_de_naissance,Region,email,mot_de_passe,ClePrive)values('RA','NyAntsa','1999-01-12','Analamanga','NyAntsa@gmail.com','NyAntsa','7');
	insert into Agri (Nom,Prenom,date_de_naissance,Region,email,mot_de_passe,ClePrive)values('RA','LOLO','2005-01-12','Vakinankaratra','zozo@gmail.com','zozo','3');
	insert into Agri (Nom,Prenom,date_de_naissance,Region,email,mot_de_passe,ClePrive)values('RA','COCO','1995-01-12','Sofia','coco@gmail.com','coco','6');
